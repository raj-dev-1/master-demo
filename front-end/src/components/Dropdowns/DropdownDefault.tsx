...
export interface DropdownDefaultProps {
  ...
  userIdnum: number | null | undefined;
}

const DropdownDefault: React.FC<DropdownDefaultProps> = ({ setDeleteModal, setUserId,setUpdateModal, userIdnum }) => {
    ...
    <div className="relative flex">
      ...
      >
        ...
        >
          ...
          >
            <path
              d="M12.225 2.20005H10.925L10.5 1.77505C10.225 1.50005 9.825 1.33337 9.4 1.33337H6.6C6.175 1.33337 5.775 1.50005 5.5 1.77505L5.075 2.20005H3.775C3.325 2.20005 2.95 2.57505 2.95 3.02505C2.95 3.47505 3.325 3.85005 3.775 3.85005H12.225C12.675 3.85005 13.05 3.47505 13.05 3.02505C13.05 2.57505 12.675 2.20005 12.225 2.20005ZM3.77495 13.8C3.77495 14.675 4.49995 15.4 5.37495 15.4H10.625C11.5 15.4 12.225 14.675 12.225 13.8V4.85005H3.77495V13.8ZM5.79995 7.10005C5.79995 6.65005 6.17495 6.27505 6.62495 6.27505C7.07495 6.27505 7.44995 6.65005 7.44995 7.10005V12.25C7.44995 12.7 7.07495 13.075 6.62495 13.075C6.17495 13.075 5.79995 12.7 5.79995 12.25V7.10005ZM8.54995 7.10005C8.54995 6.65005 8.92495 6.27505 9.37495 6.27505C9.82495 6.27505 10.2 6.65005 10.2 7.10005V12.25C10.2 12.7 9.82495 13.075 9.37495 13.075C8.92495 13.075 8.54995 12.7 8.54995 12.25V7.10005Z"
              fill=""
            />
          </svg>
          Delete
