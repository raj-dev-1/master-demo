              ...
              <form  method="POST" className="mt-8">
                <div className="space-y-5">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md bg-gradient-to-r focus:outline-none hover:bg-gradient-to-l from-fuchsia-600 to-blue-600 focus:opacity-80"
                    >
                      Sign up
                    </button>
                  </div>
